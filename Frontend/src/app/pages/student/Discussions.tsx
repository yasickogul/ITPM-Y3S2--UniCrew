      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1">
          <TabsList className="bg-gray-100/50 p-1 rounded-xl h-11">
            <TabsTrigger value="all" className="rounded-lg data-[state=active]:bg-white data-[state=active]:shadow-sm px-6">All Posts</TabsTrigger>
            <TabsTrigger value="my-posts" className="rounded-lg data-[state=active]:bg-white data-[state=active]:shadow-sm px-6">My Posts</TabsTrigger>
          </TabsList>
        </Tabs>
      </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-2 border-t border-gray-50 pt-3 mt-1">
                    <Button 
                      ...
                      className={`flex-1 sm:flex-none h-10 gap-2 rounded-xl transition-all ${isLiked ? 'text-rose-500 bg-rose-50 hover:bg-rose-100 hover:text-rose-600' : 'text-gray-500 hover:bg-indigo-50 hover:text-indigo-600'}`}
                    >
